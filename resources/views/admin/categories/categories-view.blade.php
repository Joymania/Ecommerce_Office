                            ...
                            <div class="card">
                                <div class="header">
                                    <a href="{{route('categories.create')}}">
                                        <button class="btn-primary" type="submit">Add New Category <i class="icon-plus"></i></button>
                                    </a>
                                </div>
                                <div class="body">
                                        ...
                                        <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                            ...
                                            @foreach($categories as $row)
                                                <tr>
                                                    <td>{{$row->name}}</td>
                                                    <td>
                                                        <a href="{{route('categories.edit',['category'=>$row->id])}}" class="editLink" data-toggle="tooltip" title="Edit Tag!">
                                                            <button class="editBtn"><i class="icon-note"></i></button>
                                                        </a>
                                                        <form action="{{route('categories.delete',['category'=>$row->id])}}" class="deleteForm"

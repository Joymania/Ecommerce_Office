...
<div class="card">
    <div class="card-header">
        <h3> Create User</h3> 
        <a class=" float-right btn btn-success btn-sm" href="{{ route('admin.index') }}"><i class="fa fa-list"></i> Admins List</a>
                        ...
                        <div class="body">
                            ...
                            <div class="media photo">
                                <div class="media-left m-r-15">
                                    <img src="{{ url('assets\img\space-ship.png')}}" class="user-photo media-object" alt="User" width="140px" height="140px">
                                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div>
                                <label class="fancy-radio">
                                    <input name="role" value="super_admin" type="radio" {{old('role') == 'super_admin'? "checked":null}}>
